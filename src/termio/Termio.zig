...
pub const DerivedConfig = struct {
    ...
    pub fn init(
        ...
        return .{
            ...
            .osc_1337_open_url_allowed_schemes = try alloc.dupe(
                u8,
                config.@"osc-1337-open-url-allowed-schemes",
            ),
...
pub fn init(self: *Termio, alloc: Allocator, opts: termio.Options) !void {
    ...
    const handler: StreamHandler = .{
        ...
        .osc_1337_open_url = opts.config.osc_1337_open_url,
        .osc_1337_open_url_allowed_schemes = opts.config.osc_1337_open_url_allowed_schemes,
